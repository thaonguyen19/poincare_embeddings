...
if __name__ == '__main__':
	...
	_, _, enames_train = slurp(train_dset)
	...
	for i in range(opt.interval, opt.max_epoch+1, opt.interval):
		...
		find_shortest_path(None, checkpoint_file, idx_dict, shortest_path_dict)
		find_nn(val_filename, None, checkpoint_file, out_file, duplicate_file, n_top=5, epoch=i-1)
